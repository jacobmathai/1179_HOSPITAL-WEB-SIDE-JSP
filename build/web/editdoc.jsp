<%-- 
    Document   : editdoc
    Created on : 24 Mar, 2014, 1:28:28 PM
    Author     : prasanth
--%>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
            <div id="reg">
                <center><h1>EDIT DOCTOR DETAILS</h1></center>
                <a href="view_doctor.jsp"><img src="images/cancel.png"/></a><br>
                 <table style="color: white;">
                        ...
                        <%
                         ...
                         //  JOptionPane.showMessageDialog(null, idd);
                            String sql="select * from doc_details where id='"+idd+"'";
                         ...
                         %>
                         <form method="post" action="action/editdoc_action.jsp">
                             <tr>  <td>ID</td> <td><input type="text" name="id" readonly value="<%=id%>"/></td></tr>
                             <tr>   <td>NAME</td> <td><input type="text" name="name" readonly value="<%=name%>"/></td></tr>
                             <tr>  <td>QUALIFICATION</td>   <td><input type="text" name="qua" required value="<%=qual%>"/></td></tr>
                             <tr>   <td>EXPERIENCE</td>  <td><input type="text" name="exp" required value="<%=exp%>"/></td></tr>
                             <tr>   <td>MOBILE NO</td>  <td><input type="text" name="mob" required pattern="\d{10}" value="<%=mob%>"/></td></tr>
