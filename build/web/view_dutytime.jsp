<%-- 
    Document   : view_dutytime
    Created on : 14 Oct, 2013, 11:40:06 AM
    Author     : prasanth
--%>
...
/*------------------------------------------*/
	...
	width: 530px;
      ...
      visibility: visible; position: relative; left:-105px; display: block;
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
            <div id="reg" >
                <center><h1>DOCTORS DUTY TIME</h1></center><br><br>
                <table border="0" style="color: white; width: 500px;">
                    <tr>
                        <th>NO.</th>
                        <th>&nbsp;&nbsp;DOCTOR ID</th>
                        <th>&nbsp;&nbsp;&nbsp;&nbsp;NAME</th>
                    ...
                    <tr>
                        <%
                            String sql="select * from duty_time";
