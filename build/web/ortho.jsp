            ...
            <div style="width: 800px; height: 550px; background: white; padding: 50px; border-radius: 1em; position:absolute;left: 50px;border-top:25px wheat solid; border-bottom: 5px wheat solid; border-left:5px wheat solid;border-right: 5px wheat solid; ">
                ...
                <img src="images/heart.png" style="position: absolute;left:490px; top:40px; height:400px;"></img>  
                     <div style="width:430px;">
                         <img src="images/Institute-of-Orthopaedics.png"></img>
                        
                        <h2 style="color: #1e94b2;">Apollo Expertise</h2>

<p style="color: #1e94b2;">The Apollo Institutes of Orthopedics are at the forefront in offering the latest in orthopedic treatments and surgical techniques. The centres perform surgical procedures which include the most current arthroscopic and reconstructive techniques - including major joint replacements including the Birmingham Hip resurfacing and shoulder surgeries, arthroscopies, laminectomies, the most delicate hand surgeries and much more. The most advanced medical equipment and a team of highly experienced surgeons are supported by computer navigation and imaging equipment with robotically- assisted technology.
</p></div>         
            ...
            <form name="myform" method="post" action="action/find_doc.jsp">
                <input type="radio" name="doc" id="rd1" value="nam" onclick="lod();"/>By Name. &ensp;&ensp;&ensp;&ensp;<input type="text" name="name" id="name" style="display: none;position: absolute;top:40px; left: 140px;"/><input type="image" id="namebtn" src="images/search.gif" style="display: none; height: 24px;width: 24px; position: absolute;top:40px; left: 320px;"/><br>
                  ...
                  <hr style="border:1px #1e94b2 solid;">   
                      <a href="support.jsp"><img src="images/Cancer-Institute.png"/></a>&nbsp;<a href="heart.jsp"><img src="images/Heart-Institute.png"/></a>&nbsp;<a href="more.jsp"><img src="images/more.jpeg" style="width: 220px; height:47px;"/></a>
        </div>
<!--        </div>
      </div>-->
