...
<script>
    ...
    var doctor=document.getElementById("seldoc");
      ...
      <div class="mainbar">
        <div class="article">
            <div id="reg" style="overflow-x: scroll;">
                <h1>REALLOCATE PATIENTS</h1><br><br><a href="view_doctor.jsp"><img src="images/cancel.png"></a>
                        <form action="reallocateaction.jsp" method="post" name="alloc">
                 <table  style="color: white;column-width: auto;">
                    ...
                    <tr>
                        <%
                            ...
                            session.setAttribute("q", d);
                           // JOptionPane.showMessageDialog(null,d);
                            DB.DBConnection dbc=new DBConnection();
                            String sql="select * from patient_details where status='admit' and doc_id='"+d+"'";
...
//                                JOptionPane.showMessageDialog(null, rs.getString("name"));
                        ...
                        <input type="hidden" name="id" value=<%=id%>>
                         ...
                         <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%=doc%></td>
                          <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%=dep%></td>
                          <td>&nbsp;&nbsp;&nbsp;&nbsp;<a href="reallocateaction.jsp?id=<%=id%>&c=<%=d%>">DOCTOR</a></td></tr>
                         <%       
                            }
