<%-- 
    ...
    Created on : 14 Oct, 2013, 11:34:19 AM
    Author     : prasanth
--%>
...
/*------------------------------------------*/
   ...
   #reg
	...
	width:1010px;
        ...
        visibility: visible; position: relative;  left:-350px; display: block;
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
            <div id="reg">
                <h1>DOCTORS DETAILS LIST</h1><br><br>
...
<!--                        <th>&nbsp;&nbsp;DELETE</th>-->
                    ...
                    <tr>
                        <%
                         ...
                         <td>&nbsp;&nbsp;&nbsp;&nbsp;<%=mob%></td>
                         <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%=email%></td>
                         <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%if(status==1){%><a href="action/doctorunblockaction.jsp?k=<%=id%>">Unblock</a><%} else {%><a href="action/doctorblockaction.jsp?k=<%=id%>">block</a><%}%></td>  
<!--                          <a href="changedoctor_status.jsp?id=<%=id%>"><%=status%></a>-->
                         <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="editdoc.jsp?d=<%=id%>"><img id="chumma" style="width:40px; height:40px;" src="images/user_edit.png"></a></td>
<!--                         <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="deletedoc.jsp?d=<%=id%>"><img id="chumma" style="width:40px; height:40px;" src="images/deleteuser.png"></a></td>-->
                          </tr>
                         <%       
                            }
                        %>
