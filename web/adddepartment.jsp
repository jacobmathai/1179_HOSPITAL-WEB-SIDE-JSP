      ...
      <div class="mainbar">
        ...
        <div >
            <h1><b>NEW DEPARTMENT</b><br><a href="adminhome.jsp"><img src="images/cancel.png"></a></h1></div>
                ...
                <form action="adddepartmentaction.jsp" method="post">
                   
                    <label for="timein">DEPARTMENT:</label>     
                    <input type="text" name="dept" id="dept" placeholder="Name" required pattern="^([A-Za-z\s]*)$"/>
