<%-- 
    ...
    Created on : 15 Oct, 2013, 12:15:59 PM
    Author     : prasanth
--%>
...
/*------------------------------------------*/
	...
	width: 730px;
      ...
      visibility: visible; position: relative;  left:-190px; display: block;
        ...
        <ul class="dark_menu">
            ...
            <li>
                ...
                <ul>
                    ...
                    <li><a href="#">Patient Feedbacks</a></li>
                </ul>
                <!-- Sub Menu End -->
            </li>
    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
            ...
            <div id="reg" >
                <center><h1>PATIENTS FEEDBACK</h1></center><br><br>
                <table border="0" style="color: white; width: 700px;">
                    <tr>
                        <th>No:</th>
                        <th>&nbsp;&nbsp;&nbsp;&nbsp;Id</th>
                        <th>&nbsp;&nbsp;&nbsp;&nbsp;Name</th>
