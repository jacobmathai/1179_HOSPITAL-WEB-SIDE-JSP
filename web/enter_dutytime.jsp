...
#reg
	...
	width: 330px;
      ...
      visibility: visible; position: relative;  left: -30px; display: block;
...
<script type="text/javascript">
      ...
      { if(document.getElementById('id').value==="")
          ...
          return false;
              ...
              {
                   document.getElementById('regid').innerHTML="";
          ...
          else if(document.getElementById('timein').value==="")
              {
                   document.getElementById('regid').innerHTML="";
                  document.getElementById('regn').innerHTML="";
          document.getElementById('regd').innerHTML="";
          document.getElementById('regti').style.display='block';
          return false;
          }
          else if(document.getElementById('timeout').value==="")
              {
                  ...
                  document.getElementById('regn').innerHTML="";
          document.getElementById('regd').innerHTML="";
           document.getElementById('regti').innerHTML="";
...
if (window.XMLHttpRequest)
  ...
  xmlhttp=new ActiveXObject("Microsoft.XMLHTTP");
      ...
      xmlhttp.open("POST","namid.jsp?q="+str,true);
...
if (window.XMLHttpRequest)
  ...
  xmlhttp=new ActiveXObject("Microsoft.XMLHTTP");
      ...
      xmlhttp.open("POST","namdep.jsp?q="+str,true);
      ...
      <div class="logo">
        ...
        <ul class="dark_menu">
            ...
            <li><a href="#"class="selected">Duty Time</a>
                <ul>
                    <li><a href="#">Assign Duty Time</a></li>
    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
            ...
            <div id="reg" >
        <div >
            <h1><b>ASSIGN DUTY TIME</b><br><a href="adminhome.jsp"><img src="images/cancel.png"></a></h1></div>

                <p><a id="popupContactClose"></a></p>
                
                <form action="action/dutytime_action.jsp" name="contact"method="post">
                    
                    <label for="id">DEPARTMENT:</label>
                    <select style="height: 35px;" name="Department" id="Department" required onchange="loadXMLDoc(); ">
                          <option></option>
                            <%
                                    String dep="";
                      ...
                      <select style="height: 35px;" name="name" id="name" required onchange="loadXML();">    
                    </select><span name="regn" id="regn" style="display:none;color:red"><median>Characters only</median> </span>
                  
                    
                    <label for="Department">ID:</label>
                    <select style="height: 35px;" name="id" id="id" required>
                        <option></option>
                        
                    </select><span name="regd" id="regd" style="display:none;color:red"><median>invalid department</median> </span>
                   
                    <label for="timein">START TIME:</label>
                    <input type="text" name="timein" id="timein" placeholder="hh:mm:ss" required pattern="^([0-1]?\d|2[0-3]):([0-5]?\d):([0-5]?\d)$)|(^([0-5]?\d):([0-5]?\d)$)|(^[0-5]?\d$"/><span name="regti" id="regti" style="display:none;color:red"><median>invalid time</median> </span>
                   
                   <label for="timeout">END TIME:</label>
                   <input type="text" name="timeout" id="timeout" placeholder="hh:mm:ss" required pattern="^([0-1]?\d|2[0-3]):([0-5]?\d):([0-5]?\d)$)|(^([0-5]?\d):([0-5]?\d)$)|(^[0-5]?\d$"/><span name="regto" id="regto" style="display:none;color:red"><median>invalid time</median> </span>
                   
                 
                <label for="timein">LEAVE ON(date):</label>
                <input type="date" name="leave" id="leave" placeholder="dd/mm/yyyy" required pattern=" "/><span name="reglv" id="reglv" style="display:none;color:red"><median>invalid time</median> </span>
                  <input type="submit" value="ASSIGN" onclick="return validation()"/>
                </form>
