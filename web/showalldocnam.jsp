<%-- 
    Document   : showalldocnam
    Created on : 3 Apr, 2014, 2:14:24 PM
    Author     : kishor
--%>
<%-- 
      ...
      <div class="mainbar">
        <div class="article">
          ...
          <br>
              ...
              int id[]=new int[count];
               String sql="select id from doc_details where name='"+name+"'";
       ResultSet rs=dbc.getData(sql);
        while(rs.next()){
          ...
          %>
          <span style="color: black; font-size:20px; ">Dr.<%=name%>&emsp;&emsp;&emsp;Doctor Id: <%=idd%></span><span style="position: absolute; left:362px; padding: 5px; background: wheat; height:20px; width:105px; border-radius: .5em;"><a style="text-decoration: none;font-size: 18px;" href="show_doc_1.jsp?na=<%=idd%>&nam=<%=name%>">View Profile</a></span>
