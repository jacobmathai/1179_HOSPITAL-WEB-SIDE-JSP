<%-- 
    Document   : changepass
    Created on : 24 Mar, 2014, 11:29:12 AM
    Author     : prasanth
--%>
...
/*------------------------------------------*/
   ...
   #reg
	...
	width: 360px;
      ...
      visibility: visible; position: relative;  left: -40px; display: block;
    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
         <div id="reg" >
        <div >
            <h1><b>CHANGE PASSWORD</b><br><a href="adminhome.jsp"><img src="images/cancel.png"></a></h1></div>

                <p><a id="popupContactClose"></a></p>
                
                <form action="action/changepass_action.jsp" name="contact"method="post">
                    <label for="name">CURRENT PASSWORD:</label>
                    <input type="password" name="p" id="p" placeholder="Current Password" required pattern="^([A-Za-z0-9]*)$"/><span name="regname" id="regname" style="display:none;color:red"><median>characters only</median> </span>
                    <label for="Experience">NEW PASSWORD:</label>
                    <input type="password" name="np" id="np" placeholder="New Password" required pattern="^([A-Za-z0-9]*)$"/><span name="regexp" id="regexp" style="display:none;color:red"><median>invalid Experience</median> </span>
                   
                    <label for="name">CONFIRM PASSWORD:</label>

                    <input type="password"  name="cp" id="cp"   placeholder="Confirm Password" required pattern="^([A-Za-z0-9]*)$"/><span name="regm" id="regm" style="display:none;color:red"><median>password mismatch</median> </span>
                    <input type="submit" value="CHANGE" onclick="return validation()"/>
                    <%
                        try{
                            if(request.getParameter("q").equals("1")){
                            %>
                    <span name="regm" id="regm" style="color:red"><median>Password Updated Successfully</median> </span>
                    
                    <%
                        }else{
                            %>
                    <span name="regm" id="regm" style="color:red"><median>Failed</median> </span>
                    <%
                        }
                        }catch(Exception e){
